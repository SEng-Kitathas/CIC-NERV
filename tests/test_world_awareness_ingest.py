...
class WorldAwarenessIngestTests(unittest.TestCase):
    ...
    def test_reentry_preserves_last_known_weather_but_withdraws_current_authority(self):
        ...
        for entity_id, reason in (("local-weather-surface", "awaiting fresh AviationWeather METAR observation"), ("local-weather-nws-forecast", "awaiting fresh NWS hourly forecast"), ("local-weather-radar", "awaiting fresh MRMS radar observation"), ("local-weather-radar-context", "awaiting fresh TIGERweb radar context observation"), ("local-weather-estimate", "awaiting fresh current-weather source")):
