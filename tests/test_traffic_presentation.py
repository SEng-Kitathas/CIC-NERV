...
class TrafficPresentationTests(unittest.TestCase):
    ...
    def test_unavailable_source_remains_last_known_but_is_not_authoritative(self):
        ...
        self.assertEqual(payload["summary"]["degrading_source_count"], 1)
        self.assertEqual(payload["summary"]["degrading_sources"][0]["source_key"], "drivenc_events")
        self.assertEqual(payload["summary"]["degrading_sources"][0]["adapter_id"], "drivenc.events")
    ...
    def test_http_traffic_surface_api_and_global_read_only_boundary(self):
        ...
        self.assertNotIn("003f RC2D-R2", html)
